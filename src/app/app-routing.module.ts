...
const routes: Routes = [
	...
	{ path: 'snapclerk-list', loadChildren: './snapclerk-list/snapclerk-list.module#SnapclerkListPageModule' },
	{ path: 'upload-receipt', loadChildren: './upload-receipt/upload-receipt.module#UploadReceiptPageModule' },
];
